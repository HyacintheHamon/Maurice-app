...
const EditExperience: FC = ({navigation}) => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.headerView}>
        <View style={styles.headerTitleView}>
          <Text style={styles.headerTitle}>Modifier l’expérience</Text>
        </View>
      </View>
      <KeyboardAvoidingView
        ...
        <ScrollView contentContainerStyle={styles.scrollViewContent}>
          ...
          <CustomInput
            ...
            height={60}
            error={errors.structureName ? errors.structureName?.message : null}
          />
          ...
          <DarkPurpleButton>
            <DarkPurpleButtonText>Enregistrer</DarkPurpleButtonText>
          </DarkPurpleButton>
          <PinkButton>
            <PinkButtonText>Supprimer</PinkButtonText>
          </PinkButton>
        </ScrollView>
      </KeyboardAvoidingView>
      {showStartDatePicker && (
